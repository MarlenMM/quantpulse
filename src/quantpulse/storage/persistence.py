...
def read_screener_rows(
    ...
    stmt = (
        select(
            ...
            CompositeScore.fundamental_raw,
            CompositeScore.technical_raw,
            CompositeScore.analyst_raw,
            CompositeScore.sentiment_raw,
            CompositeScore.momentum_raw,
            CompositeScore.industry_macro_raw,
            CompositeScore.smart_money_raw,
